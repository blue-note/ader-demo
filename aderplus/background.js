  ...
  if (!SAFARI) {
    ...
    frameData = {
      ...
      record: function(tabId, frameId, url) {
        ...
        fd[tabId][frameId] = {
          ...
          resources: {}
        }; console.log("HOSTNAME: "+ fd[tabId][frameId].domain);
        if (frameId === 0) {
    ...
    if(details.url == "http://img2.wikia.nocookie.net/__cb20090620065026/sonic/images/9/96/Super_Sonic_Trophy.jpg")
    {
      ...
      if (canPurge && blocked) { console.log("gotcha: "+details.url);
      ...
      console.log("[DEBUG]", "Block result", blocked, details.type, frameDomain, details.url.substring(0, 100));
      if (blocked && elType === ElementTypes.image) {
        ...
        return {redirectUrl: "http://img2.wikia.nocookie.net/__cb20090620065026/sonic/images/9/96/Super_Sonic_Trophy.jpg"
  ...
  if (!SAFARI) {
    ...
    updateButtonUIAndContextMenus = function() {
      ...
      function setBrowserButton(info) {
        ...
        if (adblock_is_paused()) {
          chrome.browserAction.setIcon({path:{'19': "Icon.png", '38': "Icon.png"}, tabId: tabId});
          ...
          chrome.browserAction.setIcon({path:{'19': "browserIcon.png", '38': "browserIcon.png"}, tabId: tabId});
          updateBadge(tabId);
        }
      }
